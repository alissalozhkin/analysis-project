"""Made a new file to try plotting all the data in one place. Maybe can merge
with a different module at a later date."""
...
# def inch_to_metre(values: float) -> float:
#     """Changes inches to metres
#     >>> inch_to_metre(-0.145669291)
#     -0.0036999999914
#     >>> inch_to_metre(0.267716535)
#     0.006799999988999999
#     """
...
def extrapolation(start_point: int, end_point: int, x_values: List[float], y_values: List[float]) -> List[float]:
